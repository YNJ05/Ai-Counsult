...
| **GPT-4o & DeepSeek** | [GitHub Models](https://github.com/marketplace/models) (free tier available) |
...
|----------------|----------------|
| Dark themed welcome with glow effect | Real-time responses with badges |
...
<p align="center">
  Made with ❤️ using Gemini, GPT-4o, and DeepSeek R1
</p>